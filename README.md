...
- Exported Rule JSON: [Azure Sentinel Analytic Rule.zip](https://github.com/user-attachments/files/21674884/Azure.Sentinel.Analytic.Rule.zip)  
...
Exported Logic App Template: [Azure Sentinel Analytic Rule.zip](https://github.com/user-attachments/files/21674884/Azure.Sentinel.Analytic.Rule.zip)  

3. <ins>Automation Rule</ins>  
...
4. <ins>Execution & Validation</ins>  
...
5. <ins>Why This Matters</ins>  
What it solves: Stops brute force attacks before account takeover.  
Why it works: Links detection (KQL analytics) directly to automation (Logic Apps).  
...
6. <ins>Proof of Incident in Sentinel</ins>  
...
7. <ins>Files</ins>  
[Azure Sentinel Analytic Rule.zip](https://github.com/user-attachments/files/21674884/Azure.Sentinel.Analytic.Rule.zip): Full Sentinel detection rule  
